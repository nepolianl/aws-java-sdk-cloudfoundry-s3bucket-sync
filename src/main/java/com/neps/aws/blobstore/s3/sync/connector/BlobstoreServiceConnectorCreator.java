...
public class BlobstoreServiceConnectorCreator extends AbstractServiceConnectorCreator<BlobstoreS3Client, BlobstoreServiceInfo> {
    private Log log = LogFactory.getLog(BlobstoreServiceConnectorCreator.class);
