...
public class BlobstoreServiceInfoCreator extends CloudFoundryServiceInfoCreator<BlobstoreServiceInfo> {
    ...
    private static String blobstoreServiceName = System.getenv(Constants.BLOBSTORE_SERVICE_NAME);
    private Log log = LogFactory.getLog(BlobstoreServiceInfoCreator.class);
